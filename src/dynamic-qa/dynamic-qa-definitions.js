...
const ENERGY_METRICS = Object.freeze({
  gas: Object.freeze({
    ...
    reference: '12,396.30', zhName: '累计用气量', enName: 'gas consumption', zhUnit: '立方米', enUnit: 'cubic meters'
  }),
  water: Object.freeze({
    ...
    reference: '44,340.23', zhName: '累计用水量', enName: 'water consumption', zhUnit: '立方米', enUnit: 'cubic meters'
  }),
  electricity: Object.freeze({
    ...
    reference: '32.26', zhName: '累计用电量', enName: 'electricity consumption', zhUnit: '吉瓦时', enUnit: 'gigawatt-hours'
  }),
  achievementRate: Object.freeze({
    ...
    reference: '97.44', zhName: '节能达成率', enName: 'energy-saving achievement rate', zhUnit: '%', enUnit: 'percent'
  })
});
